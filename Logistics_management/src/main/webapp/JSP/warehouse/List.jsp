            ...
            success: function (layero, index) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        body.contents().find("#Province").val( warehouse.warehouse.province);
                        body.contents().find("#City").val(warehouse.warehouse.city);
                        body.contents().find("#District").val( warehouse.warehouse.district);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(result.j == 0){
                        ...
                        layer.msg("库存信息中有"+result.j+"条相关信息，不能删除该仓库", {
                            icon: 1,
                            time: 1000
                        });
                    }
